<x-onixpro::layout.login>
    <x-onixpro::auth.authconteiner title="Login" image="/vendor/Onixpro/image/onixpro.png">
        <x-slot name="form">
            <x-onixpro::form.form action="{{ route('onix.login.user') }}">
                <div class="px-5 py-7">
        ...
        <x-slot name="links">
            <div class="grid grid-cols-2 gap-1">
                ...
                <div class="text-center sm:text-center whitespace-nowrap">
                    <x-onixpro::form.link route="{{ route('onix.register') }}" name="Register" />
                </div>
                <div class="text-center sm:text-center whitespace-nowrap">
