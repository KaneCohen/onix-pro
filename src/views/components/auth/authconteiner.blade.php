...
<div
    ...
    <div
        ...
        <h1 class="text-2xl font-semibold">Onixpro
            <small><a href="https://github.com/mariojgt/onixpro/wiki" target="_blank">Documentation</a></small>
        </h1>
